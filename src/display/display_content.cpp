...
void DisplayContent::createLayerContent(lv_obj_t* tab_ptr, int layerIdx) {
  ...
  lv_obj_align(ddlist, LV_ALIGN_TOP_MID, 5,5);
  lv_obj_add_event_cb(ddlist, list_event_handler, LV_EVENT_ALL, layer_user_data);
  ...
  cw = lv_colorwheel_create(tab_ptr, true);
  lv_obj_set_size(cw, 150, 150);
  lv_obj_center(cw);
  lv_obj_align_to(cw, ddlist, LV_ALIGN_OUT_BOTTOM_MID, 0, 10);
  lv_obj_add_event_cb(cw, cw_event_handler, LV_EVENT_ALL, layer_user_data);
  ...
  lv_obj_set_size(cont_col, 320, 150);
  lv_obj_align_to(cont_col, cw, LV_ALIGN_OUT_BOTTOM_MID, 0, 10);
...
void DisplayContent::setup() {
  ...
  lv_obj_t *tab2 = lv_tabview_add_tab(tabview, "Layer1");
  lv_obj_t *tab3 = lv_tabview_add_tab(tabview, "Layer2");
  
  
  createWelcomeContent(tab1);
  createLayerContent(tab2, 0);
  createLayerContent(tab3, 1);
}
